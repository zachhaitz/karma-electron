...
program.option('--window-width [width]', 'The width of the browser window in pixels');
program.option('--window-height [height]', 'The height of the browser window in pixels');
program.option('--mobile', 'The height of the browser window in pixels', false);
