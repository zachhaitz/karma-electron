...
assert(program.userDataDir, 'Expected `--app-data-dir` to be provided but it was not.');
assert(program.url, 'Expected `--url` to be provided but it was not.');

// process.chdir('/home/todd/github/karma-electron-launcher');
console.log('dafuk', process.env.NODE_PATH);
process.env.NODE_PATH = '/home/todd/github/karma-electron-launcher/node_modules';
