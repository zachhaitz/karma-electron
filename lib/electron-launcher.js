...
program.option('--hide-menu-bar', 'Boolean to make the menu bar visible', false);
program.option('--window-width', 'The width of the browser window in pixels', '500px');
program.option('--window-height', 'The width of the browser window in pixels', '500px');
