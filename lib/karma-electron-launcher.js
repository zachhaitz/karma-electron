...
// Define a helper for making Karma patterns
// https://github.com/karma-runner/karma-mocha/blob/v0.2.2/lib/index.js
...
var $inject = ['baseBrowserDecorator', 'args', 'config.files', 'config.basePath', 'config.urlRoot'];
function ElectronBrowser(baseBrowserDecorator, args, karmaFiles, karmaBasePath, karmaUrlRoot) {
  // Apply browser decorations to ourself
  baseBrowserDecorator(this);

  // Add our node integration support at the start of `files`
  // https://github.com/karma-runner/karma-mocha/blob/v0.2.2/lib/index.js
  karmaFiles.unshift(createPattern(path.join(__dirname, 'node-integration-iframe.js')));
