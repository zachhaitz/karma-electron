...
function ElectronBrowser(baseBrowserDecorator, args, basePath, urlRoot) {
  ...
  console.log('omg', basePath, urlRoot);
...
ElectronBrowser.$inject = ['baseBrowserDecorator', 'args', 'config.basePath', 'config.urlRoot'];
